...
@section('content')
    ...
    <p style="text-transform: uppercase;font-size: 16px;">Letter of Enrolment<b style="float: right;">Academic Year {{$enroll->academic_year->name}}</b></p>

    <table style="table-layout: fixed; border-collapse: collapse; width: 100%; border: none;">
        <tr>
            <td class="p-1">Full Name</td>
            <td class="p-1 dotted" colspan="3">{{strtoupper($student->full_name)}}</td>
        </tr>
        <tr>
            <td class="p-1" width="18%">NIC No</td>
            <td class="p-1 dotted" width="48%">{{$student->nic}}</td>
            <td class="p-1" width="18%">A/L Index Number </td>
            <td class="p-1 dotted" width="16%">{{$student->al_index_number}}</td>
        </tr>
        <tr>
            <td class="p-1" width="18%">Course of Study</td>
            <td class="p-1 dotted" width="49%" colspan="3">{{strtoupper($enroll->programme->name)}}</td>
               </tr>
        <tr>
            <td class="p-1" width="18%">Registration No.</td>
            <td class="p-1 dotted" width="49%">{{strtoupper($enroll->reg_no)}}</td>
            <td class="p-1" width="18%">Date of Enrolment</td>
            <td class="p-1 dotted" width="16%">{{($enroll->registration_date)?(\Carbon\Carbon::create($enroll->registration_date)->toFormattedDateString()):''}}</td>
        </tr>
    </table>
