...
We are pleased to welcome you to the University of Jaffna to follow your degree program for the Academic Year <b>{{$academic_year}}</b>.
You have been selected by the University Grants Commission (UGC) to follow the <b>{{$programme}}</b> Degree Programme at the <b>{{$faculty}}</b>.

Complete the online enrollment **before the {{$close_date}}**.

## Steps to Complete Your Enrollment:
1. **Prepare Required Documents**
To process your application, you must upload the following documents via the SIS Portal. Ensure all documents are scanned in either <b>‘jpeg’ or ‘jpg’</b> formats, with each file size being less than <b>5MB</b>.
...
You can make the payment at any branch of the <b>People’s Bank</b> in favor of the University of Jaffna Collection Account. The payment details are as follows:
    - **Amount:** LKR {{$amount}}
...
After completing the online enrollment process, print the submitted online application form and send it along with the required documents(listed on the SIS Portal) to:
    - **Senior Assistant Registrar, Admissions Branch, University of Jaffna, Ramanathan Road, Thirunelvely, Jaffna.**
    - Please indicate **"University Enrollment - {{$programme}} - {{$academic_year}}"** in the top left hand corner of the envelope.
