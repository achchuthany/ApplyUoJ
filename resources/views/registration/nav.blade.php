<ul class="nav nav-pills">
    <li class="nav-item">
        <a href="{{route('student.personal')}}" class="nav-link {{Route::currentRouteName() =='student.personal'?'active':''}}">
            <span class="rounded-circle bg-primary p-1 text-light">01</span>
            Personal
        </a>
    </li>
    <li class="nav-item">
        <a href="{{route('student.address')}}" class="nav-link {{Route::currentRouteName()=='student.address'?'active':''}} " >
            <span class="rounded-circle bg-primary p-1 text-light">02</span>
            <span>Address</span>
        </a>
    </li>
