        ...
        <div class="col-md-10 col-lg-10 col-xl-10">
            <div class="card bg-soft-info">
                <div class="card-header font-size-16 bg-info text-light">
                    ...
                    <span class="float-right">Status : {{$enroll->status}}</span>
                </div>
                <div class="card-body">
                    <div class="row mt-2">
                        <div class="col">
                            01. Personal Data of Students
                        </div>
                        <div class="col">
                            <a href="{{route('student.registration.download.PersonalData')}}" class="btn btn-sm btn-primary"> <i class="mdi mdi-download"></i> Download</a>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col">
                            02. Paying in Voucher
                        </div>
                        <div class="col">
                            <button href="#" class="btn btn-sm btn-primary"> <i class="mdi mdi-download"></i> Download</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
